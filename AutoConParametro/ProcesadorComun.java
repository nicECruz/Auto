...
public class ProcesadorComun {

	public static void procesarArchivoC(String nombreArchivoEntrada1,String nombreArchivoSalida, String nombreArchivoEntrada2) {
            ...
            while ((line = br1.readLine()) != null) {
            	...
            	if(line != "") {
        			...
        			String AuditoOpcion="|";
        			  ...
        			  String NBarraDecoI=line.substring(554, 616)+"|";//longitud 70
        			  String NBarraDecoD=line.substring(4337, 4399)+"|";//longitud 70
        			  //String NBarraDeco="                                                                      ";//longitud 70
        			  String CpeCuotaI=line.substring(2028, 2042)+"|";//longitud 19
        			  String CpeCuotaD=line.substring(5811, 5825)+"|";//longitud 19
        			  ...
        			  String CodBonif2="|";//longitud 2
        			  String PorcBonif2="|";//longitud 6
...
//        				  String PorcBonifAnual2="      |";//longitud 6
        			  ...
        			  String MDebitoAutomatico="|";//longitud 1
        			  ...
        			  String NumeroCuentaI="|";//longitud 20
        			  String NumeroCuentaD="|";
