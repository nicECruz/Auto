...
public class ProcesadorCredito {

    public static void procesarArchivoT(String nombreArchivoEntrada1,String nombreArchivoSalida, String nombreArchivoEntrada2) {
        try (BufferedReader br1 = new BufferedReader(new FileReader(nombreArchivoEntrada1));
            ...
            // Resto del código para procesar archivos de crédito...
            
            // Puedes utilizar br1 y br2 para leer los dos archivos de entrada
        	String line;
            String line2;
            String lineA;
            String lineB;
        	...
        	String codigo;
        	String CodigoCuentaI= "";
        	String CodigoCuentaD= "";
        	...
        	while ((line = br1.readLine()) != null) {
        		if(line != "") {
        			...
        			String AuditoOpcion="|";
        			  ...
        			  String CuotaI=line.substring(209,210).replaceAll(" ","3");//Longitud 1
        			  //CuotaNumI= Integer.valueOf(CuotaI);
        			  String CuotaD=line.substring(3992,3993).replaceAll(" ","3");
...
//        				  String PorcBonifAnual2="      |";//longitud 6
        			  ...
        			  String MDebitoAutomatico="T|";//longitud 1
        			  ...
        			  String NumeroCuentaI=line.substring(1331,1335)+"|";//longitud 20
        			  String NumeroCuentaD=line.substring(5114,5118)+"|";
        			  String CodigoBancoI="|";//longitud 3
        			  String CodigoBancoD="|";//longitud 3
        			  String CodigoSucursal="|";//longitud 4
        			  String CodError="|";//longitud5
        			  String LeyenError="|";//longitud 70
        			  String ProgError="|";//longitud 8
        			  //String datos_en_blanco ="                                                                                                             |";

        			  
        			  //String numeroCuenta =(line.substring(2624,2632));
          			  String descriBancoI = (line.substring(1301,1331)).replaceAll(" ",""); 
          			  String descriBancoD = (line.substring(5084,5114)).replaceAll(" ","");
//          			System.out.println("el bancoL: " +descriBancoI.length());
//          			System.out.println("el bancoL: " +descriBancoD.length());
          			  br2.mark(1000);
          			  //line2 = file2.readLine();
          			while ((line2 = br1.readLine()) != null) {
                      	if(line2!="") {
                      		String banco=line2.substring(2,32).replaceAll(" ","");
                      		System.out.println("Comparando bancoI: " +banco + "(" + banco.length() + ")" + " con descriBancoI, " + descriBancoI + "(" + descriBancoI.length() + ")");
                      		//CodigoBancoI=(line2.substring(0,2));
                      		if(banco.equals(descriBancoI)) {
                      			CodigoCuentaI=(line2.substring(0,2)+"|");
                      			System.out.println("Si se pudo encontrar el bancoI: " +banco);
                      			System.out.println("Si se pudo encontrar el bancoL: " +CodigoCuentaI.length());
//                                  break;
                      		}
                      		else {
                      			//System.out.println("No se pudo encontrar el objeto: " +objeto);
                      		}
                      		String bancoD=line2.substring(2,32).replaceAll(" ","");
//                      		System.out.println("el bancooooooL: " +bancoD.length());
                      		//CodigoBancoD=(line2.substring(0,2));
                      		System.out.println("Comparando bancoD: " +bancoD + "(" + bancoD.length() + ")"  + " con descriBancoD, " + descriBancoD  + "(" + descriBancoD.length() + ")");
                      		if(bancoD.equals(descriBancoD)) {
                      			CodigoCuentaD=(line2.substring(0,2)+"|");
                      			System.out.println("Si se pudo encontrar el bancoD: " +banco);
                      			System.out.println("Si se pudo encontrar el bancoL: " +CodigoCuentaD.length());
//                                  break;
                      		}
                      		else {
                      			//System.out.println("No se pudo encontrar el objeto: " +objeto);
